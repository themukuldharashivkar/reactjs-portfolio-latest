...
const BackgroundCircles = (props) => {
  return (
    ...
    >
      <div className="absolute border border-blue-700 opacity-20 rounded-full h-[200px] w-[200px] animate-ping mt-52" />
      <div className="absolute border border-blue-700 opacity-40 rounded-full h-[300px] w-[300px] mt-52" />
